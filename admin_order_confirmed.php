...
// Handle Ready for Delivery action
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ready_order_id'])) {
    $orderId = (int) $_POST['ready_order_id'];

    // Update order status to 'Ready for Delivery'
    $update = $connection->prepare("UPDATE orders SET order_status = 'Ready for Delivery' WHERE order_id = ? AND order_status = 'Confirmed'");
...
<div class="container">
    ...
    <main class="main-content">
        <h2 style="margin:24px 24px 0 24px;">Received Orders</h2>
        ...
        <div class="orders-list">
            ...
            if ($result->num_rows === 0) {
                echo '<div class="empty">No received orders yet.</div>';
            } else {
                    ...
                    <div class="order-card">
                        ...
                        <div class="actions">
                            <form method="post" style="margin:0;">
                                <input type="hidden" name="ready_order_id" value="<?php echo $orderId; ?>">
                                <button type="submit" class="btn btn-ready">Ready for Delivery</button>
                            </form>
                        </div>
                    </div>
                    <?php
